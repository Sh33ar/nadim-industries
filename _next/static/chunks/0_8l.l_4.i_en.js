(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,53743,e=>{"use strict";var t=e.i(95204),a=e.i(44116),i=e.i(40620),r=e.i(6842),s=e.i(79745),l=e.i(91276),n=e.i(9393),o=e.i(61018);e.s(["default",0,function(){let[e,d]=(0,s.useState)(!0);(0,s.useEffect)(()=>{document.title="Hind Mostafa"},[]);let[c,x]=(0,s.useState)(!1),[p,m]=(0,s.useState)("");(0,s.useEffect)(()=>{let e=localStorage.getItem("nadim-theme");e?d("dark"===e):d(window.matchMedia("(prefers-color-scheme: dark)").matches),x(!0)},[]),(0,s.useEffect)(()=>{c&&localStorage.setItem("nadim-theme",e?"dark":"light")},[e,c]),(0,s.useEffect)(()=>{let e=window.matchMedia("(prefers-color-scheme: dark)"),t=e=>{localStorage.getItem("nadim-theme")||d(e.matches)};return e.addEventListener("change",t),()=>e.removeEventListener("change",t)},[]);let h=e=>{m(e),setTimeout(()=>{m("")},2200)},b=async()=>{navigator.share?await navigator.share({title:"Hind Mostafa",url:window.location.href}):(navigator.clipboard.writeText(window.location.href),h("Link copied"))};return c?(0,t.jsxs)("main",{className:`
        relative
        min-h-screen
        overflow-hidden
        transition-all
      ...
      `,children:[(0,t.jsxs)("div",{className:"relative h-[54vh] min-h-[520px] overflow-hidden",children:[(0,t.jsx)("div",{className:`
          ...
          `}),(0,t.jsx)("div",{className:"absolute inset-0 pointer-events-none",children:(0,t.jsx)("div",{className:`
            ...
            `,style:{backgroundImage:`url('${e?"/nadim-industries/pattern-light.svg":"/nadim-industries/pattern-dark.svg"}')`,backgroundSize:"120px 120px",backgroundRepeat:"repeat",backgroundPosition:"center"}})}),(0,t.jsx)("div",{className:"absolute top-0 left-0 w-full z-20",children:(0,t.jsx)("div",{className:"w-full px-3 md:px-6 py-8 flex items-center",children:(0,t.jsxs)("div",{className:"flex items-center gap-5",children:[(0,t.jsx)("div",{className:"relative w-[74px] h-[74px]",children:(0,t.jsx)(a.default,{src:e?"/nadim-industries/logo-light.png":"/nadim-industries/logo-dark.png",alt:"NADIM",fill:!0,priority:!0,sizes:"74px",className:"object-contain"})}),(0,t.jsxs)("div",{children:[(0,t.jsx)("h2",{className:"text-[20px] font-semibold tracking-tight",children:o.COMPANY.name}),(0,t.jsx)("p",{className:`
                  ...
                  `,children:"Since 1978"})]})]})})}),(0,t.jsx)("div",{className:"   absolute   inset-0   z-10   flex   items-center   justify-center   -translate-y-10   ",children:(0,t.jsxs)(i.motion.div,{initial:{opacity:0,y:35},animate:{opacity:1,y:0},transition:{duration:1.2},className:"text-center px-6",children:[(0,t.jsx)("div",{className:"flex justify-center mb-1",children:(0,t.jsx)("div",{className:"relative w-[150px] h-[150px] md:w-[190px] md:h-[190px]",children:(0,t.jsx)(a.default,{src:e?"/nadim-industries/logo-light.png":"/nadim-industries/logo-dark.png",alt:"NADIM",fill:!0,priority:!0,sizes:"190px",className:"object-contain opacity-95"})})}),(0,t.jsx)("h1",{className:"   text-[58px]   md:text-[96px]   leading-[0.92]   tracking-[-0.06em]   font-black   mb-5   ",children:"Hind Mostafa"}),(0,t.jsxs)("div",{className:"flex items-center justify-center gap-5 mb-6",children:[(0,t.jsx)("div",{className:"w-[120px] h-px bg-[#C6A46A]/60"}),(0,t.jsx)("div",{className:"w-[8px] h-[8px] rotate-45 bg-[#C6A46A]"}),(0,t.jsx)("div",{className:"w-[120px] h-px bg-[#C6A46A]/60"})]}),(0,t.jsx)("p",{className:`
                uppercase
                tracking-[0.34em]
                text-[14px]
                md:text-[19px]
              ...
              `,children:"Board Member"})]})})]}),(0,t.jsx)("section",{className:"relative z-20 -mt-10 pb-28 px-6",children:(0,t.jsxs)("div",{className:"max-w-5xl mx-auto",children:[(0,t.jsx)("div",{className:"grid md:grid-cols-2 gap-5 mb-20 md:mb-24",children:[{title:"WhatsApp",value:"+2 01 22 77 99 564",href:"https://wa.me/201227799564",icon:l.FaWhatsapp},{title:"Email",value:"hind@nadim.org",href:"mailto:hind@nadim.org",icon:n.FiMail},{title:"LinkedIn",value:"linkedin.com/in/hind-mostafa",href:"https://www.linkedin.com/in/hind-mostafa/",icon:l.FaLinkedinIn},{title:"Website",value:"www.nadimgroup.com",href:"https://www.nadimgroup.com",icon:n.FiGlobe}].map((a,i)=>{let r=a.icon;return(0,t.jsxs)("a",{href:a.href,target:"_blank",rel:"noopener noreferrer",className:`
                group
                relative
                overflow-hidden
